    ...
    public partial class AddNoteForm : Form
    {
        ...
        private void AddingElements(Type type)
        {
            ...
            foreach (var item in properties)
            {
                ...
                {
                    Text = item.DeclaringType.Name == "AccountingForNotifications_Model" ? LangHelper.AccountingForNotification_ModelDictionary[item.Name] : LangHelper.AccountingForOriginals_ModelDictionary[item.Name] + $" ({LangHelper.LangTypeDictionary[item.PropertyType.Name]})",
                    Location = new Point(pointlable.X, pointlable.Y),
                    AutoSize = true
                };
